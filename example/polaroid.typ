...
#{
  ...
  render("A6", flipped: false, theme: "polaroid-bottom-two", img: img, ext-info: ext-info)
}
...
#{
  ...
  render("A6", flipped: true, theme: "polaroid-right-two", img: img, ext-info: ext-info)
}
...
#{
  ...
  render("A6", flipped: true, theme: "polaroid-right-three", img: img, ext-info: ext-info)
}